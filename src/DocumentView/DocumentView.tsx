...
const propTypes = {
  ...
  onScrollChanged: funcProp<(event: {horizontal: number, vertical: number}) => void>(),
  ...
  onAnnotationsSelected: funcProp<(event: {annotations: Array<AnnotOptions.Annotation>}) => void>(),
  onAnnotationChanged: funcProp<(event: {action: string, annotations: Array<AnnotOptions.Annotation>}) => void>(),
  ...
  onExportAnnotationCommand: funcProp<(event: {action: string, xfdfCommand: string, annotations: Array<AnnotOptions.Annotation>}) => void>(),

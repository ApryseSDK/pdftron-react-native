...
Name | Type | Description
--- | --- | ---
success | bool | whether the setting process was successful (would be true even if currently on first page)
...
Name | Type | Description
--- | --- | ---
success | bool | whether the setting process was successful (would be true even if currently on last page)

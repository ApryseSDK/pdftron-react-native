...
- (void)addAnnotation:(nonnull NSString *)type fieldName:(NSString *)fieldName pageNumber:(NSInteger *)pageNumber x1:(nonnull NSNumber *)x1 y1:(nonnull NSNumber *)y1 x2:(nonnull NSNumber *)x2 y2:(nonnull NSNumber *)y2;
